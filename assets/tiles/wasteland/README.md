...
- **Paleta de color:** BGR555 aproximada en tonos arena, arcilla cocida, arenisca oxidada, roca basáltica y acero oxidado.
...
|---|---|---|
| `T00` | `T00_wasteland_plain` | Tierra árida lisa continua (tiling seamless) con micro-costras salinas y polvo. |
| `T01` | `T01_wasteland_cracked` | Suelo árido con patrón de fisuras superficiales por choque térmico. |
| `T02` | `T02_wasteland_fissure_deep` | Fisura profunda transversal con estrías de sombra y roca basáltica expuesta. |
| `T03` | `T03_wasteland_gravel_rocks` | Esparcimiento de gravilla suelta y piedras calcinadas con bisel luminoso. |
...
| `T07` | `T07_path_junction` | Intersección / bifurcación de senderos con huellas y desgaste cruzado. |
...
| `T15` | `T15_sandbag_fortification` | Fortificación con sacos terreros apilados y piquete de alambre de espino. |
